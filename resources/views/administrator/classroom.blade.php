...
<div class="page-header row no-gutters py-4">
    <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
        ...
        <h3 class="page-title">Data Classroom</h3>
    </div>
</div>
@endsection
{{-- end page_header --}}
...
<div class="card card-small mb-4">
    <div class="card-header border-bottom">
        <div class="row">
            <div class="col-md-6">
                <h6 class="m-0">Data Classrooms</h6>
            </div>
            <div class="col-md-6">
                <button onclick="resetForm()" class="btn btn-primary float-right" data-toggle="modal"
                    data-target="#formClassroomModal">
                    <i class="material-icons mr-1">person_add</i> Create New Classroom</button>
            </div>
        </div>
    </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#formClassroom').on('submit', (function(event) {
        ...
        $(document).on('click', '#editBtn', function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#action').val('update');
                    $('#action').text('Update');
                    $('#actionLabel').text('Update Classroom');
                },
                error: function(data) {
                    var errors = data.responseJSON;
                    console.log(errors);
    ...
    function resetForm() {
        ...
        $('#action').val('create');
        $('#action').text('create');
        $('#actionLabel').text('Create New Classroom');
...
{{-- start modal --}}
<div class="modal fade" id="formClassroomModal" role="dialog" aria-labelledby="exampleModalLabel" style="display: none;"
    aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="actionLabel"> Create New Classroom</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <form action="#" method="post" id="formClassroom">
                <div class="modal-body">
                    <div id="message"></div>
                    <div class="form-group">
                        <label for="feFirstName">Classroom Name</label>
                    ...
                    <div class="form-group">
                        ...
                        <input name="quota" id="quota" class="form-control col-md-6">
                    </div>
                    <div class="form-group">
                        <label for="token">Token</label>
                        <input type="text" id="token" name="token" class="form-control col-md-6">
                    </div>
                    <div class="form-group">
